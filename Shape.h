...
public:
	...
	/*SHAPE-MANIPULATING FUNCTIONS*/
        ...
        /* virtual function that helps us translate objects of any inherited class. */
	virtual void Translate(int v, int h) = 0;
	
	 /* A virtual function that helps us search for an object from any inherited class in a given circle. */
	virtual bool IsWithinCircle(double cx, double cy, double r) const = 0;

	/* A virtual function that helps us search for an object of any inherited class in a given rectangle. */
